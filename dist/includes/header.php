...
$role=$_SESSION['role'];
$query=mysqli_query($con,"select * from roles where role_id='$role'")or die(mysqli_error($con));
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header" style="padding-left:20px">
              <a href="home.php" class="navbar-brand"><b><i class="glyphicon glyphicon-home"></i> <?php echo $role_name;?> </b></a>
