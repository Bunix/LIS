  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      <div class="login-logo">
        <b>Logistics Inventory System</b>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        //            $query3=mysqli_query($con,"select * from roles order by role_id")or die(mysqli_error($con));
        //               while($row3=mysqli_fetch_array($query3)){
                ?>
                    <option value="<?php echo $row3['role_id'];?>"><?php echo $row3['role_name'];?></option>
                  <?php //}?>
                </select>
          </div> -->
          <div class="row">
