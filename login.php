...
$query=mysqli_query($con,"select * from user natural join roles where username='$user' and password='$pass' and role_id='$role' and status='active'")or die(mysqli_error($con));
