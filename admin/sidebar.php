...
<!--           <li><a href = "application.php"><i class="fa fa-file"></i> Application<span class="fa fa-chevron-right"></span></a>     -->
				   <li><a href = "reports.php"><i class="fa fa-file"></i> Dashboard per PAMU<span class="fa fa-chevron-right"></span></a>
				   <li><a><i class="fa fa-building"></i>Inventory per PAMU <span class="fa fa-chevron-down"></span></a>
            ...
            <li><a href = "branch.php"><i class="fa fa-building"></i> PAMU <span class="fa fa-chevron-right"></span></a>
            <li><a href = "unit.php"><i class="fa fa-home"></i> UNIT <span class="fa fa-chevron-right"></span></a>
            <li><a href = "role.php"><i class="fa fa-home"></i> ROLE <span class="fa fa-chevron-right"></span></a>
                    <!--- <ul class="nav child_menu">
