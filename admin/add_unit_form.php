<div class="x_panel">
    <div class="x_title">
        <h2>Add UNIT <i class = "fa fa-users"></i></h2>
    ...
    <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action = "add_user.php" method = "POST" enctype = "multipart/form-data">
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Unit Name</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <input type="text" class="form-control" name = "name" required>
                    <span class="fa fa-flag form-control-feedback right" aria-hidden="true"required ></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <span class="fa fa-map form-control-feedback right" aria-hidden="true" required></span>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Commander</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
                    <input type="text" class="form-control" name = "name" required>
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-3 col-xs-3">PAMU</label>
                <div class="col-md-9 col-sm-9 col-xs-9">
